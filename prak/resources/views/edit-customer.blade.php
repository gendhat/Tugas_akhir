...
<body>
            ...
            <div class="position-sticky pt-3 sidebar-sticky">
                ...
                <li class="mb-1">
                    ...
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        <li><a href="{{ url('tampil-customer') }}" class="fs-6 link-dark d-inline-flex text-decoration-none rounded">Data Pelanngan</a></li>
                ...
                <li class="mb-1">
                    ...
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        <li><a href="{{ url('setting') }}" class="fs-6 link-dark d-inline-flex text-decoration-none rounded">Pengautan</a></li>
                    </ul>
                    </div>
                </li>
                </ul>
    ...
    <div class="d-flex justify-content-center flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <div class="card w-50">
            ...
            <div class="card-body">
                <form action="{{ url('update-customer')}}/{{ $post->ktp }}" method="post" >
                @csrf
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1">No KTP</span>
                    <input type="number" class="form-control @error('ktp') is-invalid @enderror"  value="{{ $post->ktp }}" name="ktp" placeholder="ktp" aria-label="ktp" aria-describedby="basic-addon1">
                    @error('ktp')
                ...
                <span class="input-group-text" id="basic-addon2">Nama Customer</span>
                    <input type="text" name="nama" min="0" class="form-control @error('nama') is-invalid @enderror"  value="{{ $post->nama }}" placeholder="nama Produk" aria-label="nama Produk" aria-describedby="basic-addon2">
                    @error('nama')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" name="no_hp" class="form-control @error('no_hp') is-invalid @enderror"  value="{{ $post->no_hp }}" id="basic-url" aria-describedby="no_hp">
                    @error('no_hp')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="alamat" min="0" class="form-control @error('alamat') is-invalid @enderror"  value="{{ $post->alamat }}" aria-label="alamat">
                    @error('alamat')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" name="usia" class="form-control @error('usia') is-invalid @enderror"  value="{{ $post->usia }}" placeholder="usia" aria-label="usia">
                    @error('usia')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
