        ...
        <div class="card w-50">
            ...
            <div class="card-body">
                ...
                <span class="input-group-text" id="basic-addon2">Harga Produk</span>
                    <input type="number" name="harga" min="0" class="form-control @error('harga') is-invalid @enderror"  value="{{ old('harga') }}" placeholder="" aria-label="" aria-describedby="basic-addon2">
                    @error('harga')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="kondisi" class="form-control @error('kondisi') is-invalid @enderror"  value="{{ old('kondisi') }}" placeholder="" aria-label="">
                    @error('kondisi')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
