                ...
                <table id="datatablesSimple">
                    <thead>
                        <tr class="table-primary">
                            <th class=" text-center" style="width: 10%"> No KTP</th>
                            <th class=" text-center" style="width: 20%"> Nama Customer</th>
                            <th class=" text-center" style="width: 10%"> Nomor HP</th>
                    ...
                    <tr>
                        ...
                        <td class="table-info text-center" style="width: 5%">
                            <a href="{{ url('delete-customer')}}/{{ $isi->ktp }}">
                                <button type="submit" class="btn btn-danger"><i class="fa-solid fa-trash"></i></button>
                            </a>
                        </td>
                        <td class="table-info text-center" style="width: 5%">
                            <a href="{{url('edit-customer')}}/{{$isi->ktp}}">
