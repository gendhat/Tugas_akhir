...
<body>
    ...
    <div class="d-flex justify-content-center flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <div class="card w-50">
            ...
            <div class="card-body">
                <form action="{{url('update-order')}}/{{ $post->kode_pemesanan }}"  method="post" >
                    @csrf
                    <div class="form-floating mb-3">
                        ...
                        <select
                            ...
                            aria-label="produk_id"
                            name="produk_id">
                                @foreach ($produk as $item)
                                    <option
                                        value="{{ $item->id }}"
                                        {{ $post->produk_id == $item->id? 'selected' : null }}
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input
                            value="{{ $post->kode_pemesanan }}"
                            type="text" class="form-control @error('kode_pemesanan') is-invalid @enderror"
                            value="{{ old('kode_pemesanan') }}"
                            name="kode_pemesanan"
                            aria-label="kode_pemesanan"
                    ...
                    <span class="input-group-text" id="basic-addon2">Jumlah Pesanan</span>
                        <input value="{{ $post->jumlah }}" type="number" name="jumlah" min="0" class="form-control @error('jumlah') is-invalid @enderror"  value="{{ old('jumlah') }}" placeholder="" aria-label="jumlah" aria-describedby="basic-addon2">
                        @error('jumlah')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
